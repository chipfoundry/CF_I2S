...
#define CF_I2S_RXDATA_REG_RXDATA_BIT	((uint32_t)0)
#define CF_I2S_RXDATA_REG_RXDATA_MASK	((uint32_t)0xffffffff)
#define CF_I2S_RXDATA_REG_MAX_VALUE	((uint32_t)0xFFFFFFFF)

#define CF_I2S_PR_REG_PR_BIT	((uint32_t)0)
#define CF_I2S_PR_REG_PR_MASK	((uint32_t)0xff)
#define CF_I2S_PR_REG_MAX_VALUE	((uint32_t)0xFF)

#define CF_I2S_AVGT_REG_AVGT_BIT	((uint32_t)0)
#define CF_I2S_AVGT_REG_AVGT_MASK	((uint32_t)0xffffffff)
#define CF_I2S_AVGT_REG_MAX_VALUE	((uint32_t)0xFFFFFFFF)

#define CF_I2S_ZCRT_REG_ZCRT_BIT	((uint32_t)0)
#define CF_I2S_ZCRT_REG_ZCRT_MASK	((uint32_t)0xffffffff)
#define CF_I2S_ZCRT_REG_MAX_VALUE	((uint32_t)0xFFFFFFFF)
...
#define CF_I2S_CTRL_REG_MAX_VALUE	((uint32_t)0xF)
...
#define CF_I2S_RX_FIFO_THRESHOLD_REG_MAX_VALUE	((uint32_t)0xF)

#define CF_I2S_RX_FIFO_FLUSH_REG_FLUSH_BIT	((uint32_t)0)
#define CF_I2S_RX_FIFO_FLUSH_REG_FLUSH_MASK	((uint32_t)0x1)
#define CF_I2S_RX_FIFO_FLUSH_REG_MAX_VALUE	((uint32_t)0x1)
...
typedef struct _CF_I2S_TYPE_ *CF_I2S_TYPE_PTR;     // Pointer to the register structure
